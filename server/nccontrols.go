...
// NCTeamPanel renders the lobby team list: unassigned players, teams with color
...
func (tp *NCTeamPanel) Focusable() bool              { return true }
func (tp *NCTeamPanel) MinSize() (int, int)           { return 16, 3 }
func (tp *NCTeamPanel) TabWant() (bool, bool)         { return tp.WantTab, tp.WantBackTab }
...
// FocusIdx after NCWindow.HandleClick returns.
func (tp *NCTeamPanel) HandleClick(rx, ry int) {}

func (tp *NCTeamPanel) Update(msg tea.Msg) {
	tp.WantTab = false
