...
func Dial(host string, port int, player string, termOverride, password string, ptyW, ptyH int, initCommands []string) (*SSHConn, error) {
	...
	if err := session.Setenv("DEV_NULL_CLIENT", "enhanced"); err != nil {
